    ...
    public function index() {
        ...
        switch($method) {
            case 'statistics':
                ...
                $type = isset($_GET['type']) && in_array($_GET['type'], ['overview', 'referrer_host', 'referrer_path', 'country', 'city_name', 'os', 'browser', 'device', 'language', 'utm_source', 'utm_medium', 'utm_campaign']) ? query_clean($_GET['type']) : 'overview';
                ...
                switch($type) {
                    ...
                    case 'city_name':
                        ...
                        $country_code = trim(query_clean($_GET['country_code']));
