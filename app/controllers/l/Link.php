    ...
    public function index() {
        ...
        if(!$has_access && !$this->is_preview) {
            ...
            if($this->link->type == 'biolink') {
                ...
                foreach(['vcard_first_name', 'vcard_last_name', 'vcard_phone', 'vcard_email', 'vcard_url', 'vcard_company', 'vcard_job_title', 'vcard_birthday', 'vcard_street', 'vcard_city', 'vcard_zip', 'vcard_region', 'vcard_country', 'vcard_note'] as $key) {
