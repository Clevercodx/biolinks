...
class BiolinkBlockAjax extends Controller {
    ...
    private function create() {
        ...
        if(isset($_POST['block_type']) && array_key_exists($_POST['block_type'], $this->biolink_blocks)) {
            ...
            $individual_blocks = ['link', 'heading', 'paragraph', 'avatar', 'socials', 'mail', 'rss_feed', 'custom_html', 'vcard', 'image', 'image_grid', 'divider', 'faq', 'discord', 'countdown', 'cta', 'external_item', 'share', 'youtube_feed', 'paypal', 'phone_collector', 'donation', 'product', 'service', 'map', 'opensea'];
    ...
    private function update_biolink_vcard() {
        ...
        $settings['vcard_phone'] = $_POST['vcard_phone'] = mb_substr(query_clean($_POST['vcard_phone']), 0, $this->biolink_blocks['vcard']['fields']['phone']['max_length']);
