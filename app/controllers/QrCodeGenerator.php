...
class QrCodeGenerator extends Controller {
    ...
    public function index() {
        ...
        switch($_POST['type']) {
            ...
            case 'vcard':
                //$_POST['vcard_first_name'] = input_clean($_POST['vcard_first_name']);
                //$_POST['vcard_last_name'] = input_clean($_POST['vcard_last_name']);
                //$_POST['vcard_phone'] = input_clean($_POST['vcard_phone']);
                ...
                //$_POST['vcard_company'] = input_clean($_POST['vcard_company']);
                //$_POST['vcard_job_title'] = input_clean($_POST['vcard_job_title']);
                //$_POST['vcard_birthday'] = input_clean($_POST['vcard_birthday']);
                //$_POST['vcard_street'] = input_clean($_POST['vcard_street']);
                //$_POST['vcard_city'] = input_clean($_POST['vcard_city']);
                //$_POST['vcard_zip'] = input_clean($_POST['vcard_zip']);
                //$_POST['vcard_region'] = input_clean($_POST['vcard_region']);
                //$_POST['vcard_country'] = input_clean($_POST['vcard_country']);
                //$_POST['vcard_note'] = input_clean($_POST['vcard_note']);
