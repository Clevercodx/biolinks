...
return [
    ...
    'create_event_modal.input.url' => 'Short URL',
    'create_event_modal.input.url_placeholder_custom' => 'your-custom-alias',
    'create_event_modal.input.url_placeholder' => 'randomly generated alias',
    'create_event_modal.input.url_help' => 'Leave empty for a random generated one.',
    ...
    'create_event_modal.error_message.url_exists' => 'Your chosen short URL already exists.',
    ...
    'create_biolink_modal.error_message.url_exists' => 'Your chosen Biolink URL already exists.',
    ...
    'tools.random_number_generator.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.file_mime_type_checker.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.list_randomizer.description' => 'Easily convert a list of given strings into a randomized list.',
    'tools.list_randomizer.meta_keywords' => '',
    'tools.list_randomizer.text' => 'Text',
    'tools.list_randomizer.result' => 'Randomized',
    'tools.list_randomizer.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.reverse_words.text' => 'Text',
    'tools.reverse_words.result' => 'Reversed',
    'tools.reverse_words.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.reverse_letters.text' => 'Text',
    'tools.reverse_letters.result' => 'Reversed',
    'tools.reverse_letters.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.emojis_remover.text' => 'Text',
    'tools.emojis_remover.result' => 'Text without emojis',
    'tools.emojis_remover.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.reverse_list.text' => 'Text',
    'tools.reverse_list.result' => 'Reversed',
    'tools.reverse_list.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.list_alphabetizer.text' => 'Text',
    'tools.list_alphabetizer.type' => 'Type',
    'tools.list_alphabetizer.result' => 'Alphabetized',
    'tools.list_alphabetizer.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.upside_down_text_generator.text' => 'Text',
    'tools.upside_down_text_generator.reverse' => 'Reverse text',
    'tools.upside_down_text_generator.result' => 'Flipped',
    'tools.upside_down_text_generator.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.old_english_text_generator.text' => 'Text',
    'tools.old_english_text_generator.result' => 'Old English',
    'tools.old_english_text_generator.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.cursive_text_generator.text' => 'Text',
    'tools.cursive_text_generator.result' => 'Cursive text',
    'tools.cursive_text_generator.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.color_picker.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
    ...
    'tools.number_to_words_converter.result' => 'Result',
    'tools.number_to_words_converter.extra_content' => 'Change me from the language manager in the admin panel. You can add extra helpful content here.',
