        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="biolink_background_type_image">
                <div class="form-group">
                    ...
                    <?php endif ?>
                    <input id="biolink_background_image" type="file" name="biolink_background_image" accept="<?= \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_background_image_extensions']) ?>" class="form-control-file altum-file-input" />
