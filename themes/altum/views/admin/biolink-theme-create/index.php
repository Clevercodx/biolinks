        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="biolink_background_type_image">
                <div class="form-group">
                    ...
                    <input id="biolink_background_type_image" type="file" name="biolink_background_image" accept="<?= \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_background_image_extensions']) ?>" class="form-control-file altum-file-input" />
                    <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_background_image_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->seo_image_size_limit) ?></small>
                </div>
            </div>
