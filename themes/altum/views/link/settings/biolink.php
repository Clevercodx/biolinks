                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="collapse" id="customization_container">
                                    ...
                                    <div class="<?= $this->user->plan_settings->custom_backgrounds ? null : 'container-disabled' ?>">
                                        ...
                                        <div id="background_type_image" data-background-container>
                                            <div class="form-group">
                                                ...
                                                <?php endif ?>
                                                <input id="background_type_image_input" type="file" name="background" accept="<?= \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_background_image_extensions']) ?>" class="form-control-file altum-file-input" />
                                                <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_background_image_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->background_size_limit) ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="favicon" type="file" name="favicon" accept="<?= \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_favicon_image_extensions']) ?>" class="form-control-file altum-file-input" />
                                    <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_favicon_image_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->favicon_size_limit) ?></small>
                                </div>
                            </div>
                                ...
                                <div <?= $this->user->plan_settings->seo ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->seo ? null : 'container-disabled' ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="seo_image" type="file" name="seo_image" accept="<?= \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_seo_image_extensions']) ?>" class="form-control-file altum-file-input" />
                                            <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \Altum\Uploads::array_to_list_format($data->links_types['biolink']['whitelisted_seo_image_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->seo_image_size_limit) ?></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
