            ...
            <div class="d-flex custom-row align-items-center my-4" data-domain-id="<?= $row->domain_id ?>">
                ...
                <div class="col-6 col-lg-3">
                    <?php if($row->is_enabled): ?>
                        <span class="badge badge-pill badge-success"><i class="fa fa-fw fa-sm fa-check"></i> <?= l('domains.table.is_enabled_active') ?></span>
                    <?php else: ?>
                        <span class="badge badge-pill badge-warning"><i class="fa fa-fw fa-sm fa-eye-slash"></i> <?= l('domains.table.is_enabled_pending') ?></span>
                    <?php endif ?>
                </div>

                <div class="d-none d-lg-flex col-lg-3">
                    <small class="text-muted" data-toggle="tooltip" title="<?= \Altum\Date::get($row->datetime, 1) ?>"><i class="fa fa-fw fa-calendar fa-sm mr-1"></i> <?= \Altum\Date::get($row->datetime, 2) ?></small>
                </div>
